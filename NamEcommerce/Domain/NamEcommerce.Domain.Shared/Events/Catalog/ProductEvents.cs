...
/// </summary>
public sealed record ProductUpdated(Guid ProductId, IReadOnlyCollection<Guid> DeletedPictureIds) : DomainEvent, IReliableDomainEvent;
...
/// </summary>
public sealed record ProductDeleted(Guid ProductId, string Name, IReadOnlyCollection<Guid> PictureIds) : DomainEvent, IReliableDomainEvent;
