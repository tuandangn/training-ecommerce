...
[Serializable]
public sealed class NotDirectShipDeliveryNotesOfOrderSpec(Guid orderId, IList<DeliveryNoteStatus>? notHaveStatus = null) 
    : BaseSpecification<DeliveryNote>((notHaveStatus is not null && notHaveStatus.Count > 0 
        ...
        .AndNot(new IsDirectShipDeliveryNoteSpec().Criteria)
    );
