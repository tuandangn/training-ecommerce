    ...
    IEntityDataReader<CustomerRefund> refundReader) : ICustomerRefundManager
{
    ...
    public async Task<CustomerRefundDto> CompleteAsync(Guid id, PaymentMethod paymentMethod, string? note, Guid? completedByUserId)
    {
        ...
        refund.Complete(paymentMethod, note, completedByUserId);
