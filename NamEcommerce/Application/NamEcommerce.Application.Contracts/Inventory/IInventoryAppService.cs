...
{
    Task<IPagedDataAppDto<InventoryStockAppDto>> GetInventoryStocksAsync(int pageIndex, int pageSize, Guid? warehouseId = null, Guid? productId = null, string? keywords = null, bool includeDirectTransit = false);
    Task<IPagedDataAppDto<InventoryStockByProductAppDto>> GetInventoryStocksGroupedByProductAsync(int pageIndex, int pageSize, Guid? warehouseId = null, string? keywords = null, bool includeDirectTransit = false);
