...
public static class ViewConstants
{
    ...
    public const string UnitMeasurementSuccessMessage = "Messages.UnitMeasurement.Success";
    public const string UnitMeasurementErrorMessage = "Messages.UnitMeasurement.Error";
