...
public sealed class RecordVendorPaymentCommand : ICommand<CommonActionResultModel>
{
...
/// </summary>
public sealed class RecordFlexibleVendorPaymentCommand : ICommand<CommonActionResultModel>
{
    public required RecordVendorPaymentModel Model { get; init; }
}

/// <summary>Ghi nhận tiền ứng trước cho NCC (chưa gắn phiếu nợ cụ thể).</summary>
public sealed class RecordVendorAdvancePaymentCommand : ICommand<CommonActionResultModel>
{
    public required RecordVendorPaymentModel Model { get; init; }
}
