...
public sealed class CreateFixedAssetCommand : ICommand<CommonActionResultModel>
{
...
public sealed class UpdateFixedAssetCommand : ICommand<CommonActionResultModel>
{
...
public sealed class DisposeFixedAssetCommand : ICommand<CommonActionResultModel>
{
    public required Guid Id { get; init; }
