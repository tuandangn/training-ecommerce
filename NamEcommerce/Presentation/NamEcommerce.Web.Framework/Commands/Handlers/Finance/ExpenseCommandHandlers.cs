...
public sealed class UpsertExpenseBudgetHandler(IExpenseBudgetAppService budgetAppService)
    : IRequestHandler<UpsertExpenseBudgetCommand, CommonActionResultModel>
{
