        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppliedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedDeliveryOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShippingPhoneNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Surcharge = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    SurchargeReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    AmountToCollect = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    ...
                    DeliveryLocationAddress = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashHandoverConfirmedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CashHandoverConfirmedByUsername = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CashHandoverConfirmedByFullName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CashHandoverConfirmedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CashHandoverAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    CashHandoverNote = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Note = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CreatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceDeliveryNoteItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InactivatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
